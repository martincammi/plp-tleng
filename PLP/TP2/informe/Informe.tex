...
\usepackage[pdfcreator={TexLive!, LaTeX2e con TeXnicCenter},
			pdfauthor={Grupo 2"},
			pdftitle={Paradigmas de Lenguajes de Programaci\'on},
			pdfsubject={Trabajo practico 2: Programaci\'on l\'ogica },
			pdfkeywords={l\'ogica, programaci\'on},
...
\section{Introducci\'on}
 ...
 En el presente trabajo pr\'actico definiremos el en paradigma l\'ogico las funciones pedidas.

\section{Distancia hamming}
	\input{distanciaHamming.tex}

\newpage
\section{Distancia de prefijos}
	\input{distanciaPrefijos.tex}

\newpage
\section{Distancia de edici\'on}
	\input{distanciaEdicion.tex}
